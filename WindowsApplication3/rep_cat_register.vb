...
Public Class rep_cat_register
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Madhushala.rep_cat_register.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrep_cat_register
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rep_cat_register = New rep_cat_register()
        rpt.Site = Me.Site
        Return rpt
    End Function
