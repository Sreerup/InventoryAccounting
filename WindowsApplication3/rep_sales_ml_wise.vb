...
Public Class rep_sales_ml_wise
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Madhushala.rep_sales_ml_wise.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrep_sales_ml_wise
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rep_sales_ml_wise = New rep_sales_ml_wise()
        rpt.Site = Me.Site
        Return rpt
    End Function
