...
Public Class rep_Sales_Bill
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Madhushala.rep_Sales_Bill.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrep_Sales_Bill
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rep_Sales_Bill = New rep_Sales_Bill()
        rpt.Site = Me.Site
        Return rpt
    End Function
