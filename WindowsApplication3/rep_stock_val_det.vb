...
Public Class rep_stock_val_det
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Madhushala.rep_stock_val_det.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrep_stock_val_det
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rep_stock_val_det = New rep_stock_val_det()
        rpt.Site = Me.Site
        Return rpt
    End Function
