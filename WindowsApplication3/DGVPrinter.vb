...
Class DataGridViewPrinter
    ...
    Private TheCompanyFont As Font
    Private TheDateFont As Font
    ...
    Public Sub New(ByVal aDataGridView As DataGridView, ByVal aPrintDocument As PrintDocument, ByVal CenterOnPage As Boolean, ByVal WithTitle As Boolean, ByVal aTitleText As String, ByVal aCompanyFont As Font, ByVal aDateFont As Font, ByVal aTitleFont As Font, ByVal aTitleColor As Color, ByVal WithPaging As Boolean)
        TheDataGridView = aDataGridView
        TheDataGridView.ColumnHeadersDefaultCellStyle.BackColor = Color.White
        TheDataGridView.DefaultCellStyle.BackColor = Color.White
        TheDataGridView.AlternatingRowsDefaultCellStyle.BackColor = Color.White

        ThePrintDocument = aPrintDocument
        IsCenterOnPage = CenterOnPage
        IsWithTitle = WithTitle
        TheTitleText = aTitleText
        TheCompanyFont = aCompanyFont
        TheDateFont = aDateFont
    ...
    Private Sub DrawHeader(ByVal g As Graphics)
        ...
        If IsWithTitle Then
            ...
            Dim TheCompanyText As String = "Company: " + Module1.companyname.ToString
            Dim TheDateText As String = "Date: " + Format(Date.Today, "dd/MM/yyyy").ToString

            Dim CompanyRectangle As New RectangleF(CSng(LeftMargin), CurrentY, CSng(PageWidth) - CSng(RightMargin) - CSng(LeftMargin), g.MeasureString(TheCompanyText, TheCompanyFont).Height)
            CurrentY = CurrentY + g.MeasureString(TheCompanyText, TheCompanyFont).Height
            Dim DateRectangle As New RectangleF(CSng(LeftMargin), CurrentY, CSng(PageWidth) - CSng(RightMargin) - CSng(LeftMargin), g.MeasureString(TheDateText, TheDateFont).Height)
            CurrentY = CurrentY + g.MeasureString(TheDateText, TheDateFont).Height
            ...
            g.DrawString(TheCompanyText, TheCompanyFont, New SolidBrush(TheTitleColor), CompanyRectangle, TitleFormat)
            g.DrawString(TheDateText, TheDateFont, New SolidBrush(TheTitleColor), DateRectangle, TitleFormat)
