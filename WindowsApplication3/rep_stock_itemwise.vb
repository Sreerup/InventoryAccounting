...
Public Class rep_stock_itemwise
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Madhushala.rep_stock_itemwise.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrep_stock_itemwise
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rep_stock_itemwise = New rep_stock_itemwise()
        rpt.Site = Me.Site
        Return rpt
    End Function
