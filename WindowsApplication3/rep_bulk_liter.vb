...
Public Class rep_bulk_liter
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Madhushala.rep_bulk_liter.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrep_bulk_liter
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rep_bulk_liter = New rep_bulk_liter()
        rpt.Site = Me.Site
        Return rpt
    End Function
